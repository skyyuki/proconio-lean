...
[`proconio`](https://docs.rs/proconio/latest/proconio/) and [`argio`](https://docs.rs/argio/latest/argio/) library for lean 4. Easy to handle input for competitive programming.
